...
Future<void> seedDatabaseIfEmpty(AppDatabase db) async {
  ...
  await db.into(db.exercises).insert(
    ExercisesCompanion.insert(
      ...
      instructions: 'Desplazar la rótula con los dedos a los lados.',
      dosageType: 'repeticiones',
      sets: Value(2),
      reps: Value(12),
      holdSeconds: const Value.absent(),
  ...
  await db.into(db.exercises).insert(
    ExercisesCompanion.insert(
      ...
      instructions: 'Pararse en el borde de un escalón (fase concéntrica).',
      dosageType: 'repeticiones',
      sets: Value(2),
      reps: Value(12),
      holdSeconds: const Value.absent(),
  ...
  await db.into(db.exercises).insert(
    ExercisesCompanion.insert(
      ...
      instructions: 'Mejorar la dorsiflexión.',
      dosageType: 'repeticiones',
      sets: Value(2),
      reps: Value(12),
      holdSeconds: const Value.absent(),
  ...
  await db.into(db.exercises).insert(
    ExercisesCompanion.insert(
      ...
      instructions: 'Caminar de espaldas en terreno seguro (activa cuádriceps).',
      dosageType: 'repeticiones',
      sets: Value(2),
      reps: Value(12),
      holdSeconds: const Value.absent(),
  ...
  await db.into(db.exercises).insert(
    ExercisesCompanion.insert(
      ...
      instructions: 'Mueve la rótula de arriba a abajo y de lado a lado con los dedos.',
      dosageType: 'repeticiones',
      sets: Value(2),
      reps: Value(12),
      holdSeconds: const Value.absent(),
  ...
  await db.into(db.exercises).insert(
    ExercisesCompanion.insert(
      ...
      instructions: 'Aprieta el cuádriceps y levanta la pierna afectada 20 cm.',
      dosageType: 'repeticiones',
      sets: Value(2),
      reps: Value(12),
      holdSeconds: const Value.absent(),
  ...
  await db.into(db.exercises).insert(
    ExercisesCompanion.insert(
      ...
      instructions: 'Juntar las paletas de la espalda (escápulas).',
      dosageType: 'repeticiones',
      sets: Value(2),
      reps: Value(12),
      holdSeconds: const Value.absent(),
  ...
  await db.into(db.exercises).insert(
    ExercisesCompanion.insert(
      ...
      instructions: 'Dar pasos largos profundizando el estiramiento excéntrico.',
      dosageType: 'estiramiento',
      sets: const Value.absent(),
      reps: const Value.absent(),
      holdSeconds: Value(25),
